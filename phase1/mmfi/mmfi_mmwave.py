...
def make_dataloader(dataset, is_training, generator, batch_size, num_workers, collate_fn):
    loader = DataLoader(
        dataset,
...
#             os.rename(os.path.join(action_path, 'Ground_truth.npy'), os.path.join(action_path, 'groundtruth.npy'))
            ...
            # os.rename(os.path.join(action_path, 'mmwave'), os.path.join(action_path, 'mmwave'))
